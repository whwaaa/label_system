$(function(){
	...
	$(".checkbox").on("click",function(){
		var size = $(".checkbox").eq(0).prop("checked")==true?1:0
		var liliao = $(".checkbox").eq(1).prop("checked")==true?1:0
		var filler = $(".checkbox").eq(2).prop("checked")==true?1:0
		var guide = $(".checkbox").eq(3).prop("checked")==true?1:0
		...
		// ----- ----- ----- -----		0000	0
		if(size == 1){
			$("#show_size").removeClass("hidden")
		}else{
			$("#show_size").addClass("hidden")
		}
		if(liliao == 1){
